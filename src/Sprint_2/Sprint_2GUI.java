...
public class Sprint_2GUI extends JFrame {
    private Sprint_2 gameLogic;
    ...
    private void startGame(int boardSize, String gameMode) {
        gameLogic = new Sprint_2(boardSize, gameMode);
        showGameScreen();
    }
    ...
    private void showGameScreen() {
        ...
        blueSButton.addActionListener(e -> {
            if (gameLogic.getCurrentPlayer().equals("blue")) {
                selectLetter('S');
            } else {
        ...
        redSButton.addActionListener(e -> {
            if (gameLogic.getCurrentPlayer().equals("red")) {
                selectLetter('S');
            } else {
        ...
        currentTurnLabel = new JLabel("Current turn: " + gameLogic.getCurrentPlayer());
    ...
    private void handleCellClick(int row, int col) {
        ...
        if (gameLogic.makeMove(row, col, selectedLetter)) {
            ...
            currentTurnLabel.setText("Current turn: " + gameLogic.getCurrentPlayer());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(Sprint_2GUI::new);
    }
}